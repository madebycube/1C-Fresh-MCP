...
| `list_product_groups`, `list_product_categories`, `list_product_characteristics`, `list_price_types`, `list_currencies`, `get_product_price`, `list_product_prices` | `update_product_group` |
