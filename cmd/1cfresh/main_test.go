...
func TestHelpExplainsCommandsWithoutCredentials(t *testing.T) {
	for _, args := range [][]string{{"--help"}, {"login", "--help"}, {"list", "groups", "--help"}, {"create", "group", "--help"}, {"update", "group", "--help"}, {"update", "product", "--help"}, {"get", "price", "--help"}, {"list", "warehouses", "--help"}, {"get", "stock", "--help"}, {"help", "list", "price-types"}} {
